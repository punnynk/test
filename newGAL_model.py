...
#
# วิธีรัน:
#   python newGAL_model.py --num_gpus 3 --end_line 53000 --phase 1
#   python newGAL_model.py --num_gpus 3 --phase 2
# =============================================================================
...
@dataclass
class Phase1Config: ## no label data training phase
    ...
    output_dir:     str = "newGAL_V1_P1_output"
    checkpoint_dir: str = "newGAL_V1_P1_checkpoints"
    log_dir:        str = "runs"
    device: str = field(default_factory=lambda: "cuda" if torch.cuda.is_available() else "cpu")
    num_gpus: Optional[int] = None      # None = ใช้หมดทุกตัวที่มี
...
@dataclass
class Phase2Config:     # fine-tuning phase config
    data_file:    str = "/share/ksl_pub/resource/Dataset/FumanDataset/Dataset/human_data_with_kosen.csv"
    text_column:  str = "text"
    ...
    output_dir:     str = "newGAL_V1_P2_output_2"
    checkpoint_dir: str = "newGAL_V1_P2_checkpoints_2"
    log_dir:        str = "runs"
    device: str = field(default_factory=lambda: "cuda" if torch.cuda.is_available() else "cpu")
